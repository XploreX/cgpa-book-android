...
import com.xplorex.cgpabook.activity.SearchActivity
import com.xplorex.cgpabook.classes.CollegeChooseModel
...
class ProfileEditFragment : Fragment() {
    ...
    private fun updateField(
        concernedField: CollegeChooseModel,
        filteredRecvString: String,
        requestCode: Int
    ) {
